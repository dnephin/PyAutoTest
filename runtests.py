...
class TestRunner(object):
    """A Test runner class for a project which uses testify. It expects
    test files to be at the same level as the source file and end with
    a _test.py.

    Example:
        packagea.module -> tests.module_test
    """
